...
with st.expander("About"):
    ...
    st.write("We are fetching data from snowflake to perform the analysis. [Data Source](https://www.kaggle.com/datasets/archit9406/customer-transaction-dataset)")
