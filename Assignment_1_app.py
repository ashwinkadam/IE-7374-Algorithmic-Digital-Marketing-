...
##################################################################
st.subheader("Which products have higher demand ?")
...
st.subheader('Understanding our top 10 customers ')
...
st.subheader('Which industries to focus ?')
...
###################################################
st.subheader('Customer segmentation by wealth')
...
st.subheader("Customer buying frequency")
